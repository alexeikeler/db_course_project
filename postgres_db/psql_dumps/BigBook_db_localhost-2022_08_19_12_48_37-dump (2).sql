...
11	5	2	2	150.00	2019-10-14	38	137	Твёрдый	Для глубокой печати
...
22	Питерский	Ратмир	admin	13500.00	+380975543234	RatmirPiter@gmail.com	ratmir_piterskij	4
...
40	test_employee	test_employee_lastname	admin	15000.00	+380999999999	asd@gmail.com	updated_test_emp_login	2
\.
...
201	updated_test_emp_login	admin	ceecdf5f881a1899183e1cf878be5332cdda541d0ba857a61ce209cb455d23d6
\.
...
SELECT pg_catalog.setval('public.chosen_chosen_id_seq', 139, true);
...
SELECT pg_catalog.setval('public.client_client_id_seq', 105, true);
...
SELECT pg_catalog.setval('public.client_order_order_id_seq', 145, true);
...
SELECT pg_catalog.setval('public.employee_employee_id_seq', 41, true);
