...
--
-- Name: update_user_order(timestamp without time zone, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_user_order(ordering_date timestamp without time zone, status character varying) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
        BEGIN
...
ALTER FUNCTION public.update_user_order(ordering_date timestamp without time zone, status character varying) OWNER TO postgres;
...
CREATE TABLE public.client_order (
    ...
    CONSTRAINT client_order_order_status_check CHECK (((order_status)::text = ANY (ARRAY[('В корзине'::character varying)::text, ('Отменён'::character varying)::text, ('Оплачен'::character varying)::text, ('В работе'::character varying)::text, ('Обработан'::character varying)::text]))),
...
28	11	95	test_address	Отменён	600.00	Наличные	4	2022-07-18 18:50:02	Thank you for applicable price	2022-07-17 01:58:13
31	15	95	test_address	В корзине	1875.00	Наличные	5	\N	Review!	2022-07-18 21:57:19
38	11	95	-	В корзине	750.00	Наличные	1	\N	-	2022-07-19 00:32:11
23	11	95	test_address	В корзине	1500.00	Наличные	2	\N	-	2022-07-15 13:38:45
24	15	95	-	В корзине	700.00	Наличные	1	\N	-	2022-07-16 17:00:48
25	11	95	test_address	В корзине	3750.00	Наличные	5	\N	Test order information.	2022-07-16 17:04:42
26	15	95	-	В корзине	450.00	Наличные	1	\N	-	2022-07-16 23:28:32
27	15	95	-	В корзине	150.00	Наличные	1	\N	-	2022-07-17 00:51:38
29	15	95	-	В корзине	700.00	Наличные	1	\N	-	2022-07-17 02:00:17
32	15	95	test_address	В корзине	1800.00	Наличные	4	\N	Returning review!	2022-07-18 21:59:54
33	15	95	test_address	В корзине	450.00	Наличные	3	\N	joke	2022-07-18 22:03:59
34	11	95	-	В корзине	150.00	Наличные	1	\N	-	2022-07-18 22:06:27
35	19	95	-	В корзине	650.00	Наличные	1	\N	-	2022-07-18 22:09:08
36	19	95	test_address	Отменён	3250.00	Наличные	5	2022-07-18 22:12:08	-	2022-07-18 22:12:04
37	19	95	-	В корзине	650.00	Наличные	1	\N	-	2022-07-18 22:14:30
30	19	95	-	В корзине	570.00	Наличные	1	\N	-	2022-07-18 20:53:09
\.
...
20	18	1	3	570.00	2008-03-03	33	850	Твёрдый	Офсетная
17	15	2	2	700.00	2011-01-12	18	600	Твёрдый	Для глубокой печати
8	2	3	2	375.00	2018-06-03	295	514	Мягкий	Офсетная
10	4	5	2	450.00	2019-03-23	24	289	Мягкий	Типографическая
11	5	2	2	150.00	2019-10-14	41	137	Твёрдый	Для глубокой печати
16	14	3	1	150.00	2018-12-22	111	145	Твёрдый	Типографическая
9	3	4	3	650.00	2019-12-02	138	621	Твёрдый	Офсетная
14	12	2	1	750.00	2013-02-13	41	331	Твёрдый	Офсетная
\.
...
SELECT pg_catalog.setval('public.chosen_chosen_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.client_order_order_id_seq', 38, true);
...
--
-- Name: FUNCTION change_client_password(login character varying, old_password character varying, new_password character varying); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.change_client_password(login character varying, old_password character varying, new_password character varying) FROM PUBLIC;
GRANT ALL ON FUNCTION public.change_client_password(login character varying, old_password character varying, new_password character varying) TO user_client;
...
GRANT ALL ON FUNCTION public.concrete_book_full_info(book_title character varying, publ_date date) TO user_checker;
...
GRANT ALL ON FUNCTION public.get_book_reviews(book_title_ character varying, book_publishing_date_ date) TO user_checker;
